# SPECS.md — Kairo Core v6.0.0 Technical Specifications

Document ID: KC-SPECS-001
Date: April 2026
Status: Canonical — Extracted from whitepaper.md (single source of truth)
Produced by: Orchestrator (Claude Code)

Rule: If a spec is not in this document, it is UNDEFINED — WP gap.
Rule: This document is read-only for agents. All changes originate from whitepaper.md.
