    ...
    2010-2020 : Observability
        ...
        2020-2025 : MLops
            ...
            2025+ : Holistic Observability (OHE)
                ...
                F < 0.3 Rested Normal
                0.3 ≤ F < 0.6 Tired Monitor
                0.6 ≤ F < 0.8 Exhausted Plan rest
                F ≥ 0.8 Burnout Restart

                5.1.4 System Mood

                ```
                M = (Uptime × Throughput) / (Errors × Timeouts × Restarts)
                ```
                ...
                Storm in 2h Pressure > 0.1 for 10m Scale up
                Burnout in 4h Fatigue > 0.7 Restart
                Epidemic in 30m Contagion > 0.6 Isolate
                Error storm Humidity > 0.4 Circuit breaker
                Crash imminent Fatigue > 0.8 AND Pressure > 0.2 Emergency
