...
<style>
  ...
  .btn-primary { background: #0284c7; border: none; color: #fff; padding: 0.35rem 0.75rem; border-radius: 5px; cursor: pointer; font-size: 0.85rem; }
  ...
  .dash-actions { margin-top: auto; display: flex; gap: 0.4rem; }
